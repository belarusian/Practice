"""CLI for training from-scratch models (NumPy-only).

Usage:
    python -m industry_ml_lab.training.from_scratch_np.cli --help
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train from-scratch GPT-2 style models (NumPy-only)"
    )

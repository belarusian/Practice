"""Example: Train on Marcus Aurelius Meditations (NumPy-only).

This example trains a GPT-2 model on Marcus Aurelius' Meditations
using ONLY NumPy. No deep learning frameworks.

Usage:
    python -m industry_ml_lab.training.from_scratch_np.examples.train_marcus
"""
...
def main():
    ...
    print("=" * 70)
    print("  Training GPT-2 on Marcus Aurelius Meditations (NumPy-only)")
    print("=" * 70)
    print()
    ...
    history = train_gpt2(
        ...
        print_every=50,
        val_fraction=0.2,
        run_dir="run_marcus_aurelius_np",
    )
    ...
    print("Training complete! Checkpoints saved to: run_marcus_aurelius_np/")

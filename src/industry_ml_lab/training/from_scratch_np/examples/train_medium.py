"""Example: Train a medium GPT-2 model on Shakespeare (NumPy-only).
...
Usage:
    python -m industry_ml_lab.training.from_scratch_np.examples.train_medium
"""
...
def main():
    ...
    print("=" * 70)
    print("  Training Medium GPT-2 on Shakespeare Sample (NumPy-only)")
    print("=" * 70)
    print()
    ...
    history = train_gpt2(
        ...
        print_every=200,
        val_fraction=0.1,
        run_dir="run_medium_shakespeare_np",
    )
    ...
    print("Training complete! Checkpoints saved to: run_medium_shakespeare_np/")

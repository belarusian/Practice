"""Example: Train a small GPT-2 model on Shakespeare.

This example trains a small GPT-2 model (~200K parameters) on a sample
of Shakespeare's text. It provides a better balance between speed and quality.

Usage:
    python -m industry_ml_lab.training.from_scratch.examples.train_small
"""
...
def get_shakespeare_sample() -> str:
    ...
    # Larger sample of Shakespeare-style text
    sample = """
...
def main():
    ...
    print("=" * 70)
    print("  Training Small GPT-2 on Shakespeare Sample")
    print("=" * 70)
    print()
    ...
    # Create model configuration (small model)
    ...
    print("Training complete! Checkpoints saved to: run_small_shakespeare/")
